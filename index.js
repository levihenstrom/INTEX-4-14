...
app.post('/donations/add/visitor', async (req, res) => {
    try {
        ...
        return res.redirect('/donations?success=' + encodeURIComponent('Thank you for your donation!'));
        // return res.redirect('/');
    } catch (err) {
        console.error('Error adding donation:', err);
        return res.redirect('/donations?error=' + encodeURIComponent('Error adding donation. Please try again.'));
...
app.get('/surveys', async (req, res) => {
    try {
        ...
        const filterState = req.query.filterState || '';
        const filterRole = req.query.filterRole || '';
        const filterEventType = req.query.filterEventType || req.query.filterInterest || '';
        ...
        if (filterEventType) {
            filteredQuery.andWhere('et.EventType', filterEventType);
        }
        if (filterSurveyID) {
        ...
        if (filterEventType) {
            registrationQuery.andWhere('et.EventType', filterEventType);
        }
        if (filterSurveyID) {

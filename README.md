...
# donations.ejs -- access for all
# -- when someone donates, give them ParticipantRole of "d"
# -- show for user. If manager, give search function to find user. manager has edit and delete access.
...
# register.ejs -- register for account
